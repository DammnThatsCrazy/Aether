"""
Aether Agent Layer — Recovery Teams
Bounded execution groups under the Recovery Controller.
"""
...
logger = logging.getLogger("aether.workers.teams.recovery")


class RecoveryTeam:
    """Bounded execution group for recovery work."""
