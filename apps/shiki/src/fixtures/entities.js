...
export const MOCK_ENTITIES = [
    // --- Customers ---
    {
        ...
        metadata: { tier: 'enterprise', mrr: 48000, region: 'us-east-1', integrationVersion: '3.2.1' },
    },
    {
        id: 'cust-nebula-002',
        type: 'customer',
        ...
        metadata: { tier: 'growth', mrr: 12000, region: 'eu-west-1', integrationVersion: '3.3.0' },
    },
    {
        id: 'cust-orion-003',
        type: 'customer',
    ...
    // --- Protocols ---
    {
        ...
        metadata: { tvl: 3200000000, chain: 'ethereum', version: '3.0', auditor: 'Trail of Bits' },
    },
    {
        id: 'proto-aave-v3',
        type: 'protocol',
        ...
        metadata: { tvl: 8700000000, chains: ['ethereum', 'polygon', 'arbitrum'], version: '3.0' },
    },
    // --- Contracts ---
    {
...
// NeedsHelp cards
// ---------------------------------------------------------------------------
export const MOCK_NEEDS_HELP_CARDS = [
    {
...
// Helpers
// ---------------------------------------------------------------------------
export function getMockEntity(id) {
    return MOCK_ENTITIES.find((e) => e.id === id);
}
export function getMockEntities(type) {
    if (!type)
        return MOCK_ENTITIES;
    return MOCK_ENTITIES.filter((e) => e.type === type);
}
export function getMockNeedsHelpCards() {
    return MOCK_NEEDS_HELP_CARDS;
}
export function getMockTimeline(entityId) {
    return MOCK_TIMELINES.find((t) => t.entityId === entityId);
}
export function getMockInterventions(entityId) {
    if (!entityId)
...
export function getMockNotes(entityId) {
    if (!entityId)
        return MOCK_NOTES;
